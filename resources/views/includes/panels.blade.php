...
<!--   <div class="bg-image" style=background-image:url('/img/two.jpg');> -->
 <!-- container open -->
<div class="container"> 
<form>
...
<br><br>
<ul class="list-group">
<li class="list-group-item  text-white bg-secondary"><b>Monthly Available Holidays</b></li>
...
<div class="h-100 d-flex justify-content-center align-items-center">
  <h3 class="badge bg-secondary">Date &nbsp;&nbsp;</h3> 
  <h3 class="badge bg-primary">Month &nbsp;&nbsp;</h3>
 <h3 class="badge bg-secondary">Year &nbsp;&nbsp;</h3> 
</div>
-->
